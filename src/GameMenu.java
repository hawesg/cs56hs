...
/** 	
*		Class - GameMenu
*		This is the menu bar including options (setup players and new game), and help
*		@author Garrett Hawes - hawesg@gmail.com
*/


public class GameMenu {
	/** Menu bar to be built */
   	private JMenuBar menuBar = new JMenuBar();
	/** The controler to comunicate with the model */
	...
	/** 	
	*		Constuct GameMenu 
	*		@param cntrl					Controler to that is linked to the model
	*/
	...
	/** 	
	*		Display a dialog with a text field for name and a combo box to select male or female
	*		@param playerNumber					The player number to setup (1 for X 2 for O)
	*/
	...
	/** 	
	*		Get the menu bar
	*		@return 						the menu bar including options and help		 
	*/
